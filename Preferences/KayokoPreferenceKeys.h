...
static NSString *const kKayokoPreferenceKeyWordSelectionPromptGradientEnabled = @"WordSelectionPromptGradientEnabled";
static NSString *const kKayokoPreferenceKeyWordSelectionPromptStartColor = @"WordSelectionPromptStartColor";
static NSString *const kKayokoPreferenceKeyWordSelectionPromptMiddleColor = @"WordSelectionPromptMiddleColor";
static NSString *const kKayokoPreferenceKeyWordSelectionPromptEndColor = @"WordSelectionPromptEndColor";
...
static BOOL const kKayokoPreferenceKeyWordSelectionPromptGradientEnabledDefaultValue = YES;
static NSString *const kKayokoPreferenceKeyWordSelectionPromptStartColorDefaultValue = @"#FF8A4C";
static NSString *const kKayokoPreferenceKeyWordSelectionPromptMiddleColorDefaultValue = @"#FF416C";
static NSString *const kKayokoPreferenceKeyWordSelectionPromptEndColorDefaultValue = @"#9B3FE5";
